...
const ProductDetails: React.FC = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row items-start  pt-[150px] pb-[120px] lg:mx-20 xl:mx-24 overflow-hidden">
      <div
      ...
      >
        ...
        <p className="mb-10 text-base font-medium leading-relaxed text-justify text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
          {product.description}
        </p>
        ...
        <ul className="px-6 mb-10 list-disc list-inside text-body-color lg:px-10 xl:px-12">
      ...
      <div className="flex-shrink-0 mt-10 lg:w-1/3 lg:mt-0 lg:ml-10 xl:ml-30">
        <video
