          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="inline-block mb-8">
                  <Image
                    src="/images/logo/XBA-logo-black.png"
                    alt="logo"
                ...
                <p className="text-base font-medium leading-relaxed mb-9 text-body-color">
                  Connecting Nodes For Seamless Insights
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="https://x.com/X_BOSON_AI?t=fnEmrXlEeQm7_xe3PBk9sg&s=09"
                    aria-label="social-link"
                    className="mr-6 text-[#CED3F6] hover:text-primary"
                  >
                    <svg
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <li>
                <a
                 href="https://github.com/xba-cpu/Caax/blob/main/Privacy%20policy"
                 target="_blank"
